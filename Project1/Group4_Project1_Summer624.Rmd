...
The first model we will test for Variable 01 is the **auto.arima** model with 1 difference and the auto lamba set to auto.  This will choose the best box.cox transformation.
```{r auto-arima-var-01}
S01_train_Var01 <- ts(select(train,Var01))

fit_var01_auto <- auto.arima(S01_train_Var01,d=1,lambda="auto")
...
The first model we will test for Variable 02 is the **auto.arima** model with 1 difference and the auto lamba set to auto.  This will choose the best box.cox transformation.
```{r  auto-arima-var-02}
S01_train_Var02 <- ts(select(train,Var02))

fit_var02_auto <- auto.arima(S01_train_Var02,d=1,lambda="auto")
